...
$waitername = trim($_GET['jswname']);
$roomnum = trim($_GET['jsroom']);
$booknum = trim($_GET['jsbook']);
...
$msg=null;
$query=null;
$query="INSERT INTO adikotnum(kotdate, bokinum, otype, waitrname, status) VALUES('$mytodaydate', '$booknum', '$roomnum', '$waitername', 'Processing')";
